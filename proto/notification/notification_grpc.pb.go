...
type NotificationServiceClient interface {
	...
	SubscribeToNotifications(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeRequest, NotificationEvent], error)
	// Send notification
...
func (c *notificationServiceClient) SubscribeToNotifications(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[SubscribeRequest, NotificationEvent], error) {
...
type NotificationService_SubscribeToNotificationsClient = grpc.BidiStreamingClient[SubscribeRequest, NotificationEvent]
...
type NotificationServiceServer interface {
	// Subscribe to task notifications (bidirectional streaming)
	SubscribeToNotifications(grpc.BidiStreamingServer[SubscribeRequest, NotificationEvent]) error
	// Send notification
...
func _NotificationService_SubscribeToNotifications_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(NotificationServiceServer).SubscribeToNotifications(&grpc.GenericServerStream[SubscribeRequest, NotificationEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type NotificationService_SubscribeToNotificationsServer = grpc.BidiStreamingServer[SubscribeRequest, NotificationEvent]
